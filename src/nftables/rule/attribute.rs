...
use netlink_packet_core::{
    ...
    DefaultNla, Emitable as _, ErrorContext as _, Nla, NlaBuffer, NlasIterator,
...
impl Nla for RuleAttribute {
    ...
    fn emit_value(&self, buffer: &mut [u8]) {
        match self {
            ...
            | Self::ChainId(value) => emit_u32(buffer, *value).unwrap(),
    ...
    fn parse(buf: &NlaBuffer<&'a T>) -> Result<Self, DecodeError> {
        ...
        Ok(match buf.kind() {
            ...
            NFTA_RULE_HANDLE => Self::Handle(
                parse_u64(payload).context("invalid NFTA_RULE_HANDLE value")?,
            ),
            ...
            NFTA_RULE_ID => Self::Id(
                parse_u32(payload).context("invalid NFTA_RULE_ID value")?,
            ),
